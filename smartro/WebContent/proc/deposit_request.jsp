...
<%
	...
	String result = jbset.get_deposit_request(tuser, stime, etime, samt, eamt, appno, pid, tradeidx,  mid, tid, acqcd, depcd, auth01, auth02, auth03, depreq1, depreq2, depreq3);
