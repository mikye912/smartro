...
<%
	...
	String rtncd = jbset.get_excel_0301(tuser, stime, etime, depcd, acqcd, mid);
	...
	response.setHeader("Content-Disposition", "inline; filename=excel0301_"+setDate.format(nowTime)+".xls");
%>
...
<table  style='border-collapse:collapse;table-layout:fixed;width:270pt'>
	<tr style='mso-height-source:userset;height:20.95pt'>
		<td class=extxt style='font-size:12pt; font-weight:bold; border-top:none;border-left:none' colspan="7">□ 입금조회</td>
	</TR>
</table>
