...
<table  style='border-collapse:collapse;table-layout:fixed;width:270pt'>
	<tr style='mso-height-source:userset;height:20.95pt'>
		<td class=extxt style='font-size:12pt; font-weight:bold; border-top:none;border-left:none' colspan="7">□ 카드사별조회</td>
	</TR>
	<tr style='mso-height-source:userset;height:20.95pt'>
...
<table  style='border-collapse:collapse;table-layout:fixed;width:270pt'>
	<tr style='mso-height-source:userset;height:15.95pt'>
		<td class=extxt style='border-top:none;border-left:none;border-right:none;' colspan="7">□ 집계자료</td>
	</TR>
	<tr style='mso-height-source:userset;height:15.95pt'>
...
<table  style='border-collapse:collapse;table-layout:fixed;width:270pt'>
	<tr style='mso-height-source:userset;height:15.95pt'>
		<td class=extxt style='border-top:none;border-left:none;border-right:none;' COLSPAN="11">□ 상세자료</td>
	</TR>
	<tr style='mso-height-source:userset;height:15.95pt'>
	...
	<%
		for(int i = 0; i<itemAry.size(); i++){
			...
			if(itemData.get(0).equals("<font color='#8B4513'><strong>소계</strong></font>") || itemData.get(0).equals("<font color='#A0522D'><strong>합계</strong></font>")){
	%>
			<tr style='mso-height-source:userset;height:15.95pt'>
