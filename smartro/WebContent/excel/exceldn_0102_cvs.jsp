...
<%
	...
	String rtncd = jbset.get_excel_0102_cvs(tuser, syear, smon, depcd);
	...
	response.setHeader("Content-Disposition", "inline; filename=excel0102_cvs_"+setDate.format(nowTime)+".xls");
...
<table  style='border-collapse:collapse;table-layout:fixed;width:270pt'>
	<tr style='mso-height-source:userset;height:20.95pt'>
		<td class=extxt style='font-size:12pt; font-weight:bold; border-top:none;border-left:none' colspan="10">□ 월일자별조회</td>
	</TR>
</table>
<TABLE><TR><TD HEIGHT="10"></TD></TR></TABLE>
<table  style='border-collapse:collapse;table-layout:fixed;width:270pt'>
	<tr style='mso-height-source:userset;height:15.95pt'>
		<td class='extxt' style='border-top:none;border-left:none;border-right:none;' COLSPAN="10">□ 집계자료</td>
	</TR>
	<tr style='mso-height-source:userset;height:15.95pt'>
		<td class='extxt' colspan="4"></td>
		<td class='extxt'>승인건수</td>
		<td class='extxt'>승인금액</td>
		<td class='extxt'>취소건수</td>
		<td class='extxt'>취소금액</td>
	...
	%>
	<tr style='mso-height-source:userset;height:15.95pt'>
		<td class='extxt' colspan="4">합계</td>
...
<table  style='border-collapse:collapse;table-layout:fixed;width:270pt'>
	<tr style='mso-height-source:userset;height:15.95pt'>
		<td class='extxt' style='border-top:none;border-left:none;border-right:none;' COLSPAN="7">□ 상세자료</td>
	</TR>
	<tr style='mso-height-source:userset;height:15.95pt'>
	...
	<%
		for(int i = 0; i<itemAry.size(); i++){
			...
			if(result.equals("소계") || result.equals("합계")){
				
	%>
	<TR style='mso-height-source:userset;height:15.95pt'>
		<TD class='extxt'style="text-align:center;"><%=itemData.get(0)%></TD>
		<TD class='exnum'><%=itemData.get(1)%></TD>
		<TD class='exnum'><%=itemData.get(2)%></TD>
