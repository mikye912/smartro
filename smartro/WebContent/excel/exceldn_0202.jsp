...
<table  style='border-collapse:collapse;table-layout:fixed;width:270pt'>
	<tr style='mso-height-source:userset;height:15.95pt'>
		<td class='extxt' style='border-top:none;border-left:none;border-right:none;' COLSPAN="10">□ 상세자료</td>
	</TR>
	<tr style='mso-height-source:userset;height:15.95pt'>
	...
	<%
		for(int i = 0; i<itemAry.size(); i++){
			...
			if(result.equals("<font color='#8B4513'><strong>소계</strong></font>") || result.equals("<font color='#A0522D'><strong>합계</strong></font>")){
