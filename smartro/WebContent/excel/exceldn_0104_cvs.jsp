...
<%
	...
	String rtncd = jbset.get_excel_0104_cvs(tuser, stime, etime, samt, eamt, appno, tradeidx, auth01, auth02, auth03, mid, tid, acqcd, tid2);
	...
	response.setHeader("Content-Disposition", "inline; filename=excel0104_cvs_"+setDate.format(nowTime)+".xls");
%>
