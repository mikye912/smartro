...
<%
	...
	String rtncd = jbset.get_0310_excel(tuser, reqstime, reqetime, stime, etime);
...
<table  style='border-collapse:collapse;table-layout:fixed;width:270pt'>
	...
	<tr style='mso-height-source:userset;height:15.95pt'>
		...
		<td class=extxt>일반승인건수</td>
		<td class=extxt>일반승인금액</td>
		<td class=extxt>일반취소건수</td>
		<td class=extxt>일반취소금액</td>
		<td class=extxt>일반합계건수</td>
		<td class=extxt>일반합계금액</td>
		<td class=extxt>할부승인건수</td>
		<td class=extxt>할부승인금액</td>
		<td class=extxt>할부취소건수</td>
		<td class=extxt>할부취소금액</td>
		<td class=extxt>할부합계건수</td>
		<td class=extxt>할부합계금액</td>
		<td class=extxt>총합계건수</td>
		<td class=extxt>총합계금액</td>
		<td class=extxt>청구요청자</td>
