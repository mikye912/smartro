...
<%
	...
	//2021.02.23 mid 넘어왔을 때
	String mid = utilm.setDefault(request.getParameter("mid"));
	
	//String rtn_json = jbset.get_0204_item(tuser, stime, etime, tid, appno, samt, eamt, mid, pid, tridx, depcd, casher, cardno, authchk);
	String rtn_json = jbset.get_0204_item(tuser, stime, etime, samt, eamt, appno, acqcd, pid, mediid, medi_cd, cardno, tid, tradeidx, depcd, auth01, auth02, auth03, mid);
	out.print(rtn_json);
%>