...
//String getpage = utilm.setDefault(request.getParameter("page"));

String rtn_json = jbset.get_0106_cvs_item(tuser, stime, etime, samt, eamt, appno, tradeidx, auth01, auth02, auth03, mid, tid, acqcd, tid2);
